<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Jazztastic3ASPXWebForms.Register" %>
...
<head runat="server">
    ...
    <title>Jazztastic 3- Register</title>
...
<body>
    ...
    <img class="img-responsive" src="images/tickets_2_transformed_register.jpg" style="position: absolute; z-index: -100;" />
    <form name="regForm" id="regForm" onsubmit="return false;" runat="server">
...
<div id="map_container" class="row" style="display: none">
    <div class="col-md">
                    ...
                    <div class="col-md-4">
                            <div class="tab">
                                <div class="form-group">
                                    ...
                                    <input runat="server" id="fname" autocomplete="off" type="text" class="form-control details0" name="fname" pattern="[a-zA-Z\s]+" title="First name must consist only of letters!" maxlength="32" required oninvalid="this.setCustomValidity('First name must consist only of letters and be up to 32 characters!')" oninput="setCustomValidity('')">
                                    <div id="fNameValidation" runat="server" style="color: red;"></div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname">Last name:</label>
                                    <input runat="server" id="lname" autocomplete="off" type="text" class="form-control details0" name="lname" pattern="[a-zA-Z\s]+" title="Last name must consist only of letters!" maxlength="32" required oninvalid="this.setCustomValidity('Last name must consist only of letters and be up to 32 characters!')" oninput="setCustomValidity('')">
                                    <div id="lNameValidation" runat="server" style="color: red;"></div>
                                </div>
                                <div class="form-group">
                                    <label for="govid">Government ID:</label>
                                    <input runat="server" id="govid" autocomplete="off" class="form-control details0" name="govid" oninput="setCustomValidity(''); javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="11" type="number" required oninvalid="this.setCustomValidity('Please provide government ID!')">
                                    <div id="govtIdValidation" runat="server" style="color: red;"></div>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email address:</label>
                                    <input id="email" autocomplete="off" type="email" class="form-control details0" name="email" required oninvalid="this.setCustomValidity('Please provide email address!')" oninput="setCustomValidity(''); javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="64"">
                                    <div id="emailAddressValidation" runat="server" style="color: red;"></div>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Password:</label>
                                    <input type="password" id="password" class="form-control" name="pwd" pattern=".{6,32}" title="Password must be between 6 and 32 characters!" required oninvalid="this.setCustomValidity('Password must be between 6 and 32 characters!')" oninput="setCustomValidity('')" maxlength="32">
                                    <div id="passwordValidation" runat="server" style="color: red;"></div>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Confirm password:</label>
                                    <input type="password" id="confirm_password" class="form-control" name="confirmpwd" required maxlength="32">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="date">Date of birth</label>
                                    <input runat="server" type="text" autocomplete="off" class="form-control details0" id="dob" name="dob" data-date-end-date="01-07-2000" required oninvalid="this.setCustomValidity('Please provide a date of birth!')" oninput="setCustomValidity('')" onchange="setCustomValidity()"/>
                                    <div id="dobValidation" runat="server" style="color: red;"></div>
                                </div>
                                <label class="control-label" for="date">Ticket dates</label>
                                <div class="form-row">
                                    <div class="form-group col">
                                        <input runat="server" autocomplete="off" type="text" class="form-control details0" id="ticketDate" name="ticketDate" required oninvalid="this.setCustomValidity('Please provide ticket dates!')" oninput="setCustomValidity('')" onchange="setCustomValidity()" />
                                    </div>
                                    <div class="form-check col-6">
                                        <input id="map_enabler" class="form-check-input mt-2 checkbox" type="checkbox" style="margin-left: -2rem;" >
                                        <label class="form-check-label" style="margin-top: 0.25rem; font-size: 1.2rem;">+ Camping (3-days) </label>
                                    </div>
                                </div>
                                <div class="col-12" id="ticketTypeValidation" runat="server" style="color: red;"></div>
                                <div class="form-check pb-3">
                                    <input id="termsAndConditionsCheckbox" class="form-check-input checkbox" type="checkbox" required oninvalid="this.setCustomValidity('Please agree with the terms and conditions before proceeding!')" oninput="setCustomValidity('')">
                                    <label class="form-check-label ml-2 mt-1">
                                        Agree with <a href="termsAndConditions.txt" target="_blank">Terms and conditions</a>
                                    </label>
                                </div>
                            ...
                            <div class="tab">
                                ...
                                <div class="icon-container">
                                    <i class="fab fa-cc-visa pr-3" style="color: darkgreen; font-size: 5rem"></i>
                                    <i class="fab fa-cc-amex pr-3" style="color: midnightblue; font-size: 5rem"></i>
                                    <i class="fab fa-cc-mastercard pr-3" style="color: orangered; font-size: 5rem"></i>
                                    <i class="fab fa-cc-discover pr-3" style="color: silver; font-size: 5rem"></i>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Name on card</label>
                                    <input id="nameOnCard" autocomplete="off" name="nameOnCard" pattern="[a-zA-Z\s]+" title="Please input correct credit/debit card name!" type="text" class="form-control details1" maxlength="32" required oninvalid="this.setCustomValidity('Please input correct credit/debit card name!')" oninput="setCustomValidity('')" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Card number</label>
                                    <input name="cardNumber" id="cardNumber" onkeydown="restrictLetters()" type="text" class="form-control creditCardText details1" pattern=".{19,}" title="Please input correct credit/debit card format!" maxlength="19" required oninvalid="this.setCustomValidity('Please input correct credit/debit card format!')" oninput="setCustomValidity('')" onchange="setCustomValidity()" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="date">Expiration date</label>
                                    <input autocomplete="off" class="form-control details1" id="expDate" name="expDate" type="text" required oninvalid="this.setCustomValidity('Please provide expiration date!')" oninput="setCustomValidity('')" onchange="setCustomValidty()" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">CVV</label>
                                    <input autocomplete="off" min="100" max="999" id="cvv" class="form-control details1" name="cvv" type="number" required oninvalid="this.setCustomValidity('Please provide a valid CVV!')" oninput="setCustomValidity(''); javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="3" />
                                </div>
                                <h2 id="totalPrice">Total price €50</h2>
                            </div>
                            <button id="prevBtn" type="button" onclick="nextPrev(-1);" class="btn btn-primary btn-block">Previous</button>
                            <button type="submit" onserverclick="nextBtn_ServerClick" id="nextBtn" onclick="nextPrev(1);" class="btn btn-primary btn-block" runat="server">Next</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="span12">
                        <div class="thumbnail center well well-small text-center">
                            <h3>Subscribe to newsletter</h3>
                                ...
                                <button runat="server" id="buttonSubscribe" class="btn btn-lg btn-primary" onserverclick="Subscribe_Click">Subscribe Now!</button>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
    ...
    <script>
        ...
        function nextPrev(n) {
            ...
            if (!CheckAvailability(document.getElementById("ticketDate").value)) {
                return;
            }
            if (document.getElementById("map_enabler").checked == true) {
                if (document.getElementById("finishedCampingCheckbox").checked == false || spotNumber == 0) {
                    console.log(document.getElementById("finishedCampingCheckbox").checked);
                    console.log(spotNumber);
                    alert("Select a spot first or uncheck camping checkbox!");
                    return;
                }
            }
            ...
            var numberPeople = document.getElementById("rangeOneToSix").value;
            if (ticketDate.includes("01/07/2018"))
                ticketType += "T";
            else
                ticketType += "F";
            if (ticketDate.includes("02/07/2018"))
                ticketType += "T";
            else
                ticketType += "F";
            if (ticketDate.includes("03/07/2018"))
                ticketType += "T";
            else
                ticketType += "F";

            var tTimes = ticketType.replace(/[^T]/g, "").length;
            if (tTimes == 1)
                price = 40;
            else if (tTimes == 2)
                price = 45;
            ...
            if (spotNumber != 0) {
                if (areaNumber == "A")
                    price += 1.10 * (numberPeople * 20);
                else
                    price += numberPeople * 20;
            }
            document.getElementById("totalPrice").innerHTML = "Total price - €" + price;
            if (document.getElementById("map_enabler").checked)
                $("#map_container").fadeIn();
            if (currentTab == x.length - 1 && document.getElementById("map_enabler").checked)
                $("#map_container").fadeOut();
            showTab(currentTab);
        }
        ...
        function validateForm() {
            ...
            var list = document.getElementsByClassName("details" + currentTab);
            ...
            if (!document.getElementById("fname").value.match(letters) || !document.getElementById("lname").value.match(letters)) {
                return false;
            }
            if (document.getElementById("fname").value.length > 32
                || document.getElementById("lname").value.Length > 32
                || document.getElementById("govid").value.length > 11
                || document.getElementById("email").value.length > 64 || !document.getElementById("email").value.includes("@")
                || document.getElementById("dob").value.length > 10 || document.getElementById("dob").value.length < 10)
                return false;
            ...
            if (currentTab == 1) {
                if (document.getElementById("cvv").value < 100 || document.getElementById("cvv").value > 999)
                    return false;
            ...
            if (!validatePasswordBool(password, confirmPassword))
                return false;
    ...
    <!-- script to disable credit number letters -->
    <script>
    ...
    <!-- credit card scripts -->
    <script>
        $('.creditCardText').keydown(function (event) {
    ...
    <!-- dashes between credit card numbers -->
    <script type="text/javascript">
    ...
    <script>
        ...
        function validatePasswordBool(password, confirmPassword) {
    ...
    <script>
        $(document).ready(function () {
            ...
            var container = $('#register form').length > 0 ? $('#register form').parent() : "body";
            var options = {
                container: container,
                autoclose: true,
    ...
    <script>
        ...
        <!--dob onchange script to fix validation problem -->
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var list = [];
            list.push.apply(list, document.getElementsByClassName("details0"));
            list.push.apply(list, document.getElementsByClassName("details1"));
            for (var i = 0; i < list.length; i++) {
                list[i].onchange = validateField;
            }
            if (document.getElementById("ticketTypeValidation").innerHTML != "") {
                $('html, body').animate({
